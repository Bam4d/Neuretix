...
LDLIBSOPTIONS=-Wl,-rpath,../CMarkup/dist/Debug/GNU-Linux-x86 -L../CMarkup/dist/Debug/GNU-Linux-x86 -lCMarkup

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libCavalCade.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libCavalCade.${CND_DLIB_EXT}: ../CMarkup/dist/Debug/GNU-Linux-x86/libCMarkup.so
...
${OBJECTDIR}/CyclicCacheEvent.o: CyclicCacheEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/CyclicCacheEvent.o CyclicCacheEvent.cpp

${OBJECTDIR}/CyclicCacheTimePoint.o: CyclicCacheTimePoint.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/CyclicCacheTimePoint.o CyclicCacheTimePoint.cpp
...
${OBJECTDIR}/CyclicCache.o: CyclicCache.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/CyclicCache.o CyclicCache.cpp
