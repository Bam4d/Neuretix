...
# Test Files
TESTFILES= \
	${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cavalcadetests
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cavalcadetests: ${TESTDIR}/tests/CyclicCacheTestClass.o ${TESTDIR}/tests/CyclicCacheTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc}   -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cavalcadetests $^ ${LDLIBSOPTIONS} 
...
.test-conf:
	@if [ "${TEST}" = "" ]; \
	then  \
	    ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cavalcadetests || true; \
	else  \
	    ./${TEST} || true; \
	fi
